export const passwordRegistrationBundleTemplate = (
  email: string,
  password: string,
) => `
      <!DOCTYPE html>
      ...
      <body>
          <div class="container">
              ...
              <div class="content">
                  ...
                  <p>Additionally, access to the Participate Practically course will be shared with you promptly via the same email.</p>
