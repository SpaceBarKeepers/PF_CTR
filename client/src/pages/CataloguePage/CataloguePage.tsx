  ...
  useEffect(() => {
    setFilteredTools(
      tools.filter((tool: ToolEntity) => {
        ...
        if (countryFilter) {
          const countryCode = shippingCountrySelectArray.find(
            (item) => item.label === countryFilter,
          )?.value;
      ...
      <div className={'cataloguePage'}>
        ...
        <div className={'cataloguePage__tools'}>
          ...
          <div className={'cataloguePage__toolsList'}>
            {filteredTools
              .sort((a, b) => a.toolsName.localeCompare(b.toolsName))
              .map((tool) => (
                <div
                ...
                >
                  <div className={'cataloguePage__toolsListItemHead'}>
                    ...
                    <div
                      className={
                        'cataloguePage__toolsListItemHead__logoWrapper'
                      }
                    >
                  ...
                  <p>{tool.descEn}</p>
                  <ButtonColored childIsLink={false}>Open</ButtonColored>
                </div>
              ))}
          </div>
        </div>
